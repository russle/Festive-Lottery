...
export const RollingPhase: React.FC = () => {
    ...
    return (
        <div className="w-full max-w-5xl text-center">
            ...
            <div className="relative bg-red-950/60 border-y-4 border-amber-500/50 backdrop-blur-md p-16 overflow-hidden rounded-2xl shadow-2xl">
                ...
                <div className={`relative font-black text-white tracking-tight drop-shadow-md whitespace-nowrap ${lottery.currentRollingName.length > 3 ? 'text-5xl md:text-7xl' : 'text-7xl md:text-9xl'}`}>
                    {lottery.currentRollingName}
                </div>
            </div>

            <div className="mt-12">
                <button
                    onClick={lottery.stopRolling}
